...
public class MachineChooserGroup {
	...
	private RodinElementComboViewer<IMachineRoot> machineChooser;
	...
	public void addSelectionChangedListener(ISelectionChangedListener listener) {
		machineChooser.addSelectionChangedListener(listener);
	}

	/**
	 * Remove a selection changed listener of the machine chooser.
	 * 
	 * @param listener
	 *            a selection changed listener.
	 */
	public void removeSelectionChangedListener(
		...
		machineChooser.removeSelectionChangedListener(listener);
	}
