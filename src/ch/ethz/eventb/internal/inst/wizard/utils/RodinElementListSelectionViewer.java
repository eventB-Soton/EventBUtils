...
/**
 * <p>
 * A viewer to choose a list of elements which are children of an input element.
 * The input element need to be set by {@link #setInput(IParent)}.
 * </p>
 * 
 * @param <T>
 ...
 * @author htson
 */
public class RodinElementListSelectionViewer<T extends IRodinElement> {
	 ...
	 */
	public RodinElementListSelectionViewer(Composite parent, IElementType<T> type,
			String title) {
		this.type = type;
	...
	private void createViewer(final Composite comp) {
		...
		selectedViewer = createListViewer(parent, false);
	 ...
	 *            the parent element.
	 */
	public void setInput(IParent element) {
		availableViewer.setInput(element);
		selectedViewer.setInput(element);
		refresh();
	}
	...
	public void addSelectionChangedListener(ISelectionChangedListener listener) {
		selectedViewer.addSelectionChangedListener(listener);
	}

	/**
	 * Remove a selection change listener of the selected viewer.
	 * 
	 * @param listener
	 *            a selection changed listener.
	 */
	public void removeSelectionChangedListener(
		...
		selectedViewer.removeSelectionChangedListener(listener);
	}
