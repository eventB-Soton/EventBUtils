...
/**
 * <p>
 * An extension of {@link ComboViewer} to provide a way to choose a Rodin
 * element from a combo list. The list of objects in the combo are of the same
 * type (set by the constructor), and belong to the same parent (which can be
 * dynamically set after initialized). {@link #setInput(Object)}). This is
 * copied from the pattern plug-in
...
public class RodinElementComboViewer<T extends IRodinElement> extends
	...
	public void setElement(T element) {
		IStructuredSelection ssel = new StructuredSelection(element);
		this.setSelection(ssel);
	}
