...
public class EventBUtilsTests extends EventBTests {
	...
	/**
	 * Test method for {@link EventBUtils#normalise(IEvent)}.
	 */
	@Test
	public void testNormaliseEvent() {
		try {
			EventBUtils.normalise(evt1_1_1);
			testEventActions("Normalise event 1", evt1_1_1,
					"merged_act: x, y :∣ x' ∈ {a, b} ∧ y' = 0");

			EventBUtils.normalise(evt1_1_2);
			testEventActions("Normalise event 2", evt1_1_2,
					"merged_act: x, y :∣ x' = b ∧ y' = y + 2");

			EventBUtils.normalise(evt1_1_3);
			testEventActions("Normalise event 3", evt1_1_3,
					"merged_act: x, y :∣ x' ∈ S ∖ {s} ∧ y' = y − 4");

			EventBUtils.normalise(evt1_2_1);
			testEventActions("Normalise event 4", evt1_2_1,
					"merged_act: x, v :∣ x' ∈ {a, b} ∧ v' = y + 2");

			EventBUtils.normalise(evt1_2_2);
			testEventActions("Normalise event 5", evt1_2_2,
					"merged_act: x, y, u, v :∣ x' = b ∧ y' = y + 2 ∧ u' = e ∧ v' = v + 1");

			EventBUtils.normalise(evt1_2_3);
			testEventActions("Normalise event 6", evt1_2_3,
					"merged_act: x, y, v :∣ x' ∈ S ∖ {s} ∧ y' = y − 4 ∧ v' = v + 1");

			EventBUtils.normalise(evt1_2_4);
			testEventActions("Normalise event 7", evt1_2_4,
					"merged_act: v, u :∣ v' = v − 1 ∧ u' = e");

			EventBUtils.normalise(evt1_3_1);
			testEventActions("Normalise event 8", evt1_3_1,
					"merged_act: v :∣ v' = 2");

			EventBUtils.normalise(evt1_3_2);
			testEventActions("Normalise event 9", evt1_3_2,
					"merged_act: y, u, v :∣ y' = y + 2 ∧ u' = e ∧ v' = v + 1");

			EventBUtils.normalise(evt1_3_3);
			testEventActions("Normalise event 10", evt1_3_3,
					"merged_act: y, v :∣ y' = y − 4 ∧ v' = v + 1");

			EventBUtils.normalise(evt1_3_4);
			testEventActions("Normalise event 11", evt1_3_4,
					"merged_act: v, u, p :∣ v' = v − 1 ∧ u' = e ∧ p' = p{r ↦ h}");

			EventBUtils.normalise(evt1_3_5);
			testEventActions("Normalise event 12", evt1_3_5,
					"merged_act: z :∣ z' = z − 1");
		} catch (RodinDBException e) {
			e.printStackTrace();
			fail("There should be no exception");
	...
	/**
	 * Test method for {@link EventBUtils#normalise(IAction)}.
	 */
	@Test
	public void testNormaliseAction() {
		try {
			EventBUtils.normalise(act1_1_1_1);
			testAction("Normalise action 1", act1_1_1_1,
					"act1_1_1_1: x :∣ x' ∈ {a, b}");

			EventBUtils.normalise(act1_1_1_2);
			testAction("Normalise action 2", act1_1_1_2,
					"act1_1_1_2: y :∣ y' = 0");

			EventBUtils.normalise(act1_1_2_1);
			testAction("Normalise action 3", act1_1_2_1,
					"act1_1_2_1: x, y :∣ x' = b ∧ y' = y + 2");

			EventBUtils.normalise(act1_1_3_1);
			testAction("Normalise action 4", act1_1_3_1,
					"act1_1_3_1: x :∣ x' ∈ S ∖ {s}");

			EventBUtils.normalise(act1_1_3_2);
			testAction("Normalise action 5", act1_1_3_2,
					"act1_1_3_2: y :∣ y' = y − 4");

			EventBUtils.normalise(act1_2_1_1);
			testAction("Normalise action 6", act1_2_1_1,
					"act1_2_1_1: x :∣ x' ∈ {a, b}");

			EventBUtils.normalise(act1_2_1_2);
			testAction("Normalise action 7", act1_2_1_2,
					"act1_2_1_2: v :∣ v' = y + 2");

			EventBUtils.normalise(act1_2_2_1);
			testAction("Normalise action 8", act1_2_2_1,
					"act1_2_2_1: u :∣ u' = e");

			EventBUtils.normalise(act1_2_2_2);
			testAction("Normalise action 9", act1_2_2_2,
					"act1_2_2_2: v :∣ v' = v + 1");

			EventBUtils.normalise(act1_2_3_1);
			testAction("Normalise action 10", act1_2_3_1,
					"act1_2_3_1: v :∣ v' = v + 1");

			EventBUtils.normalise(act1_2_4_1);
			testAction("Normalise action 10", act1_2_4_1,
					"act1_2_4_1: v, u :∣ v' = v − 1 ∧ u' = e");

			EventBUtils.normalise(act1_3_1_1);
			testAction("Normalise action 11", act1_3_1_1,
					"act1_3_1_1: v :∣ v' = 2");

			EventBUtils.normalise(act1_3_2_1);
			testAction("Normalise action 12", act1_3_2_1,
					"act1_3_2_1: y :∣ y' = y + 2");

			EventBUtils.normalise(act1_3_2_2);
			testAction("Normalise action 13", act1_3_2_2,
					"act1_3_2_2: u :∣ u' = e");

			EventBUtils.normalise(act1_3_2_3);
			testAction("Normalise action 14", act1_3_2_3,
					"act1_3_2_3: v :∣ v' = v + 1");

			EventBUtils.normalise(act1_3_3_1);
			testAction("Normalise action 15", act1_3_3_1,
					"act1_3_3_1: y :∣ y' = y − 4");

			EventBUtils.normalise(act1_3_3_2);
			testAction("Normalise action 16", act1_3_3_2,
					"act1_3_3_2: v :∣ v' = v + 1");

			EventBUtils.normalise(act1_3_4_1);
			testAction("Normalise action 17", act1_3_4_1,
					"act1_3_4_1: p :∣ p' = p{r ↦ h}");

			EventBUtils.normalise(act1_3_5_1);
			testAction("Normalise action 18", act1_3_5_1,
					"act1_3_5_1: z :∣ z' = z − 1");
		} catch (RodinDBException e) {
			e.printStackTrace();
			fail("There should be no exception");
